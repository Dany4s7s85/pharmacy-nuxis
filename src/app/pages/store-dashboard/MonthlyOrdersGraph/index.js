...
import { getPharmacyMonthlySaleReporting } from "../../../services/pharmacyDashboard";
...
const MonthlyOrdersGraph = ({ count }) => {
  ...
  const monthlySalesLoading = useSelector(
    (state) => state?.pharmacyDashboard?.pharmacyMonthlySaleReporting?.loading
  );

  useEffect(() => {
    dispatch(
      getPharmacyMonthlySaleReporting(selectedMonths, function (res) {
