...
import { getPharmacyOrderReportingCards } from "../../../services/pharmacyDashboard";
import {
...
const SaleOrdersCards = ({ count }) => {
  ...
  const orderReportingloading = useSelector(
    (state) => state?.pharmacyDashboard.pharmacyOrderReportingCards.loading
  );

  useEffect(() => {
    dispatch(
      getPharmacyOrderReportingCards(function (res) {
...
export default SaleOrdersCards;
